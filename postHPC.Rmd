...
getBasePanelAndMarkers(seu = adtInVitro_matched, tsa_catalog = tsa_catalog, findMarkerMethod = "DESeq2",
  pngFn = "outs/png/InVitro_basepanel.png", tsvFn = "outs/tsv/InVitro_initClusterMarkers.tsv")

getBasePanelAndMarkers(seu = adtChronic_matched, tsa_catalog = tsa_catalog, findMarkerMethod = "DESeq2",
  pngFn = "outs/png/chronic_basepanel.png", tsvFn = "outs/tsv/chronic_initClusterMarkers.tsv")

getBasePanelAndMarkers(seu = adtART_matched, tsa_catalog = tsa_catalog, findMarkerMethod = "DESeq2",
...
plotDiscreteBar(projInvitro_matched, "outs/png/inVitro_discreteHivOnly_matched.png",
  cluster = "manualClusterAnnot",
  graphType = "hivOnly")
```
...
plotDualUmap(projChronic_matched,
  fn = "outs/png/chronic_labeledCluster_dualUmap.png",
  cluster = "manualClusterAnnot",
  embedding = "UMAP2")

plotDiscreteBar(projChronic_matched, "outs/png/chronic_discreteProportion_matched.png",
  cluster = "manualClusterAnnot",
  graphType = "proportion")

plotDiscreteBar(projChronic_matched, "outs/png/chronic_discreteAbsolute_matched.png",
  cluster = "manualClusterAnnot",
  graphType = "absolute")

plotDiscreteBar(projChronic_matched, "outs/png/chronic_discreteHivOnly_matched.png",
  cluster = "manualClusterAnnot",
  graphType = "hivOnly")
```
...
plotDualUmap(projART_matched,
  fn = "outs/png/art_labeledCluster_dualUmap.png",
  cluster = "manualClusterAnnot")

plotDiscreteBar(projART_matched, "outs/png/art_discreteProportion_matched.png",
  cluster = "manualClusterAnnot",
  graphType = "proportion")

plotDiscreteBar(projART_matched, "outs/png/art_discreteAbsolute_matched.png",
  cluster = "manualClusterAnnot",
  graphType = "absolute")

plotDiscreteBar(projART_matched, "outs/png/art_discreteHivOnly_matched.png",
  cluster = "manualClusterAnnot",
  graphType = "hivOnly")
```
...
makeDifferentialLollipop(invitro_markers, "outs/png/invitro_lollipop.png")
...
makeDifferentialLollipop(invitro_activeLate_markers, "outs/png/invitro_lollipop_activeLate.png")
...
makeDifferentialLollipop(invitro_activeLate_markers, "outs/png/invitro_lollipop_early.png")
...
ggsave(filename = "outs/png/invitro_activatedHIVvolcano.png", plot = activatedVolcano, dpi = "retina", height = 4.5, width = 4.5)
rm(activatedVolcano)
...
plotMotifRank <- function(motifChanged, nLabel = 15) {
  ...
  g <- ggplot(df, aes(rank, mlog10Padj)) + 
    ...
    geom_point(size = 0.5, color = "#00000080", shape = 16) +
    ...
    labs(x = "Rank Sorted TFs Enriched",
      y = "-log10(adj p) Motif Enrichment")
  
  return(g)
}

ggsave("outs/png/invitro_motifsUp_activatedHIVneg.png", plot = plotMotifRank(motifsDown), width = 3, height = 3, dpi = "retina")
ggsave("outs/png/invitro_motifsUp_activatedHIVpos.png", plot = plotMotifRank(motifsUp), width = 3, height = 3, dpi = "retina")
```

```{r}
chronic_tcells_check <- !(adtChronic_matched$manualClusterAnnot %in% c("B", "Monocyte", "APC"))
...
makeDifferentialLollipop(chronic_markers, "outs/png/chronic_lollipop.png")
```
