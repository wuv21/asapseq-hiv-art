...
plotVlnEnhanced(adtInVitro_matched, cells = names(invitro_activeLaterCells),
  feats = invitro_activeLate_markers$gene,
  xVar = "haystackOut",
  showAggregate = FALSE,
  separator = invitro_activeLate_markers$Status,
  titles = invitro_activeLate_markers$cleanName,
  fn = "invitro_activated_vln")
...
savePlot(invitro_markerTest_activatedPeaks_topPeaks, fn = "invitro_markerTest_activated_topPeaks", devices = c("png", "rds"), gheight = 3.5, gwidth = 7)
