...
**Supplemental Table 5:** Significant surface markers enriched in each cluster (over all other cells) during treated infection.
```{r, echo=FALSE, message=FALSE}
...
**Supplemental Table 6:** Significant surface markers enriched in HIV+ versus HIV- cells during treated infection.
```{r, echo=FALSE, message=FALSE}
prepareDEMarkerTableCompiled(
  fns = c(
...
**Supplemental Table 7:** Autologous virus sequences used in study.
```{r, echo=FALSE, message=FALSE}
