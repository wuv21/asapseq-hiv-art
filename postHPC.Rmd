...
art_other_check <- (grepl("(APC|Other)", adtART_matched$manualClusterAnnot))
art_OtherCells <- adtART_matched$haystackOut[art_other_check]
art_markers_other <- findHIVDifferentialMarkers(seu = adtART_matched,
  cellsPos = names(art_OtherCells[art_OtherCells]),
  cellsNeg = names(art_OtherCells[!art_OtherCells]),
  featuresToUse = ARTAdtToUse,
  findMarkerMethod = "wilcox",
  tsa_catalog = tsa_catalog)

makeDifferentialLollipop(art_markers_other, "art_lollipop_other")
exportTsv(art_markers_other)
