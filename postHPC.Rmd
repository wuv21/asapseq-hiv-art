...
plotUmap(projInvitro_matched, colorBy = "Clusters", fn = "InVitro_umap_unlabeledCluster")
...
plotUmap(projChronic_matched, colorBy = "Clusters", fn = "chronic_umap_unlabeledCluster", embedding = "UMAP2")
...
plotUmap(projART_matched, colorBy = "Clusters", fn = "art_umap_unlabeledCluster")
...
plotUmap(projInvitro_matched, colorBy = "manualClusterAnnot", fn = "InVitro_umap_labeledCluster")
plotUmap(projInvitro_matched, colorBy = "manualClusterAnnot", fn = "InVitro_umap_labeledCluster_noPlotLabels", labelColors = FALSE)
...
projChronic_matched <- addBgdPeaks(projChronic_matched)
...
data.frame(
  fdr = log10(chronic_markerTest@assays@data@listData$FDR$`T cell_TRUE`) * -1,
  meandiff = chronic_markerTest@assays@data@listData$MeanDiff$`T cell_TRUE`,
  motif = chronic_markerTest@elementMetadata@listData[["name"]]) %>%
  filter(fdr > -1 * log10(0.05)) %>%
